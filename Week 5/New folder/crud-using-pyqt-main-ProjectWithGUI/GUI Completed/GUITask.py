...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -8, 1153, 1812))
...
"")
        ...
        self.cmbDistrict = QtWidgets.QComboBox(self.groupBox_4)
        self.cmbDistrict.setEnabled(True)
        self.cmbDistrict.setGeometry(QtCore.QRect(30, 100, 271, 31))
...
"")
        ...
        self.cmbTehsil = QtWidgets.QComboBox(self.groupBox_4)
        self.cmbTehsil.setGeometry(QtCore.QRect(370, 100, 271, 31))
...
"")
        ...
        self.cmbTehsil.addItem("")
        self.cmbTehsil.addItem("")
        self.cmbStampPaperType = QtWidgets.QComboBox(self.groupBox_4)
        self.cmbStampPaperType.setGeometry(QtCore.QRect(30, 180, 271, 31))
...
"")
        ...
        self.cmbStampPaperType.addItem("")
        self.cmbDeed = QtWidgets.QComboBox(self.groupBox_4)
        self.cmbDeed.setGeometry(QtCore.QRect(370, 180, 271, 31))
...
"")
        ...
        self.txtEmail.setGeometry(QtCore.QRect(330, 140, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.txtCNIC = QtWidgets.QLineEdit(self.groupBox_3)
        self.txtCNIC.setGeometry(QtCore.QRect(330, 90, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txtCNIC.setFont(font)
        self.txtCNIC.setFrame(True)
        self.txtCNIC.setClearButtonEnabled(True)
        self.txtCNIC.setObjectName("txtCNIC")
        self.lblAgentCNIC_4 = QtWidgets.QLabel(self.groupBox_3)
        self.lblAgentCNIC_4.setGeometry(QtCore.QRect(330, 73, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.txtName = QtWidgets.QLineEdit(self.groupBox_3)
        self.txtName.setGeometry(QtCore.QRect(47, 90, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txtName.setFont(font)
        self.txtName.setClearButtonEnabled(True)
        self.txtName.setObjectName("txtName")
        self.txtContact = QtWidgets.QLineEdit(self.groupBox_3)
        self.txtContact.setGeometry(QtCore.QRect(50, 140, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txtContact.setFont(font)
        ...
        self.btnFirstParty = QtWidgets.QPushButton(self.groupBox_5)
        self.btnFirstParty.setEnabled(True)
        self.btnFirstParty.setGeometry(QtCore.QRect(500, 10, 191, 38))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btnFirstParty.setFont(font)
        self.btnFirstParty.setStyleSheet("color:green;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plus/images.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnFirstParty.setIcon(icon1)
        self.btnFirstParty.setIconSize(QtCore.QSize(30, 30))
        self.btnFirstParty.setFlat(True)
        self.btnFirstParty.setObjectName("btnFirstParty")
        ...
        self.btnSecondParty = QtWidgets.QPushButton(self.groupBox_6)
        self.btnSecondParty.setEnabled(True)
        self.btnSecondParty.setGeometry(QtCore.QRect(500, 10, 191, 38))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btnSecondParty.setFont(font)
        self.btnSecondParty.setStyleSheet("color:green;")
        self.btnSecondParty.setIcon(icon1)
        self.btnSecondParty.setIconSize(QtCore.QSize(30, 30))
        self.btnSecondParty.setFlat(True)
        self.btnSecondParty.setObjectName("btnSecondParty")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnFirstParty.setText(_translate("MainWindow", "Add First Party"))
        self.label.setText(_translate("MainWindow", "Please add at least one First Party"))
        self.btnSecondParty.setText(_translate("MainWindow", "Add Second Party"))
